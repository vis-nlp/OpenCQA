...
class MultiBartQA:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--log_file_path',
                            type = str,
                            default = 'trained_models/log.txt',
                            help = 'Log file')
...
# if we refer to paper, this implementation requires source to be context and context to be documents
    ...
    def train(self):
        ...
        dev_examples = self.load_examples(self.args.data_dir, 'test.json')
        ...
        if os.path.exists(cached_features_trainfile):
            ...
            train_examples = self.load_examples(self.args.data_dir, 'train.json')
    ...
    def generate(self):
        ...
        if self.args.experiment_type == 'chat_wizard':
            ...
            test_examples = self.load_examples(self.args.data_dir, 'test.json')
