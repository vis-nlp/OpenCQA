...
class FinetuningConfig(object):
  ...
  def __init__(self, model_name, data_dir, **kwargs):
    ...
    # for qa tasks
    self.max_query_length = 128   # max tokens in q as opposed to context
    ...
    self.max_answer_length = 200  # filter out answers longer than this length
    self.answerable_classifier = False  # answerable classifier for SQuAD 2.0
