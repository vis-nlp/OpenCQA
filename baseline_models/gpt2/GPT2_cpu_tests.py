...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_len', default=800, type=int, help="max seq length model can take is 2048")
                    ...
                    for epoch_idx in range(args.pretuning_epoch):
                        ...
                        for idx in range(0, dataset.train_len()):
                            ...
                            if args.chart_load_format == 'krl':
                                ...
                                a = prof.key_averages().table(sort_by="self_cpu_memory_usage")
            ...
            for idx in range(0, dataset.train_len()):
                ...
                if args.chart_load_format == 'krl':
                    ...
                    if args.transfer_learn == True:
                        ...
                        b = prof.key_averages().table(sort_by="self_cpu_memory_usage")
