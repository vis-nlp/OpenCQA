...
def read_examples(args, input_file, is_training, version_2_with_negative):
...
def main():
    ...
    parser.add_argument('--load_charts_from',
                            type = str,
                            default = 'data/chart_images/',
                            help = "load charts path")
    ...
    if args.do_train:
        train_examples = read_examples(
            args=args, input_file=args.train_file, is_training=True, version_2_with_negative=args.version_2_with_negative)
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        eval_examples = read_examples(
            args=args, input_file=args.predict_file, is_training=False, version_2_with_negative=args.version_2_with_negative)
